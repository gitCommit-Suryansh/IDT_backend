...
exports.getEntryById = async (req, res) => {
  try {
    ...
    const entry = await ContestEntry.findById(entryId).populate('userId', 'name profileImage').populate('contestId', 'name');
    ...
    try {
      ...
      if (authHeader && authHeader.startsWith('Bearer ')) {
        ...
        if (admin && admin.auth) {
          ...
          } catch (e) { console.error('Token Verify Failed', e.message); };
